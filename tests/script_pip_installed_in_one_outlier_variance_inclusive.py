...
def EEG_sleep_loose_lead(in_name_temp, opt_paramters):
    ...
    # Here onwards MT-estimation and correlation based loose-lead detection begins
    # --------------------------------------------------------------------------
    ...
    # --------------------------------------------------------------------------
    #finalise the loose lead detection the following hyper-parameters are just 
    # annotate the whole lead as loose-lead based on the conditions
    # --------------------------------------------------------------------------
